...
export const festivalLinupes: Festival[] = [
  ...
  },
  {
    ...
    endDate: '2024-05-22',
    festivalStatus: 'BEFORE',
    description: '2024년 서울시립대학교 대동제',
    url: 'https://www.instagram.com/uos_season',
    festivalFiles: [
      {
        originalFileName: 'image',
        mimeType: 'pdf',
        file: 'https://scontent.cdninstagram.com/v/t39.30808-6/440114681_18094684501418343_489915871254643341_n.jpg?stp=dst-jpg_e35&efg=eyJ2ZW5jb2RlX3RhZyI6ImltYWdlX3VybGdlbi4yMDQ4eDIwNDguc2RyLmYzMDgwOCJ9&_nc_ht=scontent.cdninstagram.com&_nc_cat=103&_nc_ohc=FR-Mm9lstx4Q7kNvgHn8RaB&edm=APs17CUAAAAA&ccb=7-5&ig_cache_key=MzM1NjA2OTY2NDQxMTg5NDQzNw%3D%3D.2-ccb7-5&oh=00_AYDVDsPOURYhC1MzyfkCqkhBXAnqoij6v9hdf-WzfYJq2w&oe=66457894&_nc_sid=10d13b',
        type: 'POSTER',
      },
    ],
  },
